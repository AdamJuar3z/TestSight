...
SELECT * 
FROM Vehicle 
WHERE year_made BETWEEN min AND max;
...
SELECT * 
FROM Vehicle 
WHERE odometer BETWEEN min AND max;

SELECT * 
FROM Vehicle 
WHERE vehicle_type = 'vehicleType';

INSERT INTO Vehicle (VIN, vehicle_type, odometer, year_made, make, model, color, price, sold, ActualCashValue) 
VALUES ('vehicle.VIN', 'vehicle.vehicle_type', vehicle.odometer, vehicle.year_made, 'vehicle.make', 'vehicle.model', 'vehicle.color',
 vehicle.price, vehicle.sold, vehicle.ActualCashValue);
